            ...
            <div className="h-[32rem] bg-gray-100 dark:bg-gray-700">
                <div className="container px-6 py-10 mx-auto">
                    ...
                    <p className="max-w-2xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
                        <b>Code geeks :</b> Our team consists of three
                        programmers from Meraki Academy. After hard work and a
                        period of 3 weeks, we produced this website with the
                        cooperation of all team members. I am pleased to
                        introduce you to the personalities of our team.
                    </p>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                        <img
                            ...
                            src="https://res.cloudinary.com/dbkfrtdjm/image/upload/v1697217838/Mohammed_Alabed_ftdefh.jpg"
                            alt=""
                        />
                    ...
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                        <img
                            className="object-cover w-full rounded-xl aspect-square"
                            src="https://res.cloudinary.com/dbkfrtdjm/image/upload/v1697217848/Qutada_Albluwi_alt9j4.jpg"
                            alt=""
                        />
                    ...
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                        <img
                            className="object-cover w-full rounded-xl aspect-square"
                            src="https://res.cloudinary.com/dbkfrtdjm/image/upload/v1697218223/Abdullah_Aljamal_rcio7k.jpg"
                            alt=""
                        />
