        ...
        <nav>
            {!token ? (
                ...
                <div>
                    ...
                    <NavLink to="/cart" className={"navbar-margin"}>
                        Cart
                    </NavLink>
                    <NavLink onClick={handleLogout} className={"navbar-margin"}>
                        Logout
                    </NavLink>
                    <NavLink to="/category" className={"navbar-margin"}>
                        Employee Category{" "}
                    </NavLink>
                    <NavLink
                        to={`employeeProfile/${userId}`}
